...
const SettingsPage: React.FC<SettingsPageProps> = ({ theme, setTheme, onBack, onUpdateProfile }) => {
    ...
    const handleBackgroundUpdate = (croppedImage: string) => {
        onUpdateProfile({ profileBgUrl: croppedImage });
        ...
        <>
            {isUploaderOpen && (
                <ImageUploader
                    ...
                    onCropComplete={handleBackgroundUpdate}
                    aspectRatio={16 / 9}
                    cropShape="rect"
                    maxFileSizeMB={1}
                />
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-gray-100 dark:bg-gray-700/50 p-4 rounded-lg flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            ...
                            <span className="font-medium text-gray-900 dark:text-white">Фон профіля</span>
                        </div>
                        <button 
